...
<div class="row">
<!-- menu1 -->
<nav class="navbar navbar-default" role="navigation" id="menu5">
<div class="container-fluid">
<!-- Brand and toggle get grouped for better mobile display -->
<div class="navbar-header">
<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex4-collapse">
...
<div class="col-xs-12 col-lg-10 col col-md-12 col-lg-offset-1">
    <ul class="youtube-videogallery">
        <? foreach($Videos as $video) { ?>
        <li><a href="<?=$video->url?>"><?=$video->titulo?></a></li>
		<? } ?>
    </ul>
    </div>
