<?
					       if ($resultado){
					       	...
					       	$tituloBoton = 'Editar';
					       	$tituloH = 'Edita Imagen pie de página';
					       }
?>
...
<div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-edit"></i>  <?=utf8_encode($tituloH)?>
                            </li>
                        </ol>
                    </div>
                </div>
...
<div class="row">
					<div class="col-lg-6 col-lg-offset-3">
                        ...
                        <form role="form" enctype="multipart/form-data" method="post" action="<?=base_url()?>ImageFoot/Editalo">
                        ...
                        <div class="form-group">
                                <label>Imagen JPG (1920 x 466)</label>
