...
<li class="active"><a href="semblanza">LA OFA</a></li>
			...
			<!-- menu1 -->
				<nav class="navbar navbar-default" role="navigation" id="menu3">
						...
						<div class="collapse navbar-collapse navbar-ex1-collapse">
							<ul class="nav nav-justified">
								<li <?=($tipo == 1 ? 'class="active"' : '')?>><a href="semblanza">SEMBLANZA</a></li>
								<li <?=($tipo == 2 ? 'class="active"' : '')?>><a href="misionvision">MISIÓN Y VISIÓN</a></li>
								<li <?=($tipo == 3 ? 'class="active"' : '')?>><a href="integrantes">INTEGRANTES</a></li>
								<li <?=($tipo == 4 ? 'class="active"' : '')?>><a href="director">DIRECTOR</a></li>
							</ul>
						</div><!-- /.navbar-collapse -->
				</nav>
				<!-- end menu1 -->
...
<img src="uploads/Nosotros/foto/<?=$nota[0]->foto?>" class="img-responsive center-block">
</div>
</div>
<div class="row gray2">
<div class="col-lg-12 text-center"><h4><?=$tipo2?></h4></div>
</div>
